    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top" style="background: #ADD8E6 !important;">
     ...
     include("../model/config.php");
      ...
      <div id="content-wrapper" style="margin-left: 15px">
        ...
        <h3><i class="fas fa-fw fa fa-desktop"></i> Configurações do Monitor</h3>
        <?php
            $lista_status = array();
            $lista_monitor = array();
         ...
         ?>
          <form action="../controller/atualiza_monitor.php" method="POST">
            <!-- tipo !-->
          Tipo principal:
          <select class="form-control" name="tipo_id">
              <?php
                  if($lista_monitor[0]["tipo_principal"] == 1)
                  {
