  ...
  <body id="page-top">
    ...
    <div id="wrapper">
     ...
     <div id='content-wrapper' style='margin-left: 15px'>
        ...
        ?>
        <h3><i class="fas fa-envelope" title="Chat"></i> Chat</h3>
        <br>        
              <table class="table table-bordered" width="40%" cellspacing="0">
                <thead>
                    <tr>
                      <th>Nome</th>
                      <th></th>
          ...
          <?php
              ...
              foreach ($data as $row) 
              {
                  if($usuario_id != $row['id'])
                  {
                    echo "<tbody><tr><td><i class='fas fa fa fa-user-circle'></i> ".$row['nome']."</td>";
                    //salto =  + 15920 - 350
                    $id = $row['id'] + 15920 - 350;
                    echo "<td>
                      <a href='chat_conversa.php?id=".$id."?id_user=".$var_hash."'><i class='fas fa fa-comment' title='Mensagens'></i> Mensagens</a>
                    </td></tr></tbody>";   
                  }
              }
          ?>
