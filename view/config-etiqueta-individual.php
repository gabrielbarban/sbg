  ...
  <body id="page-top">
    ...
    <div id="wrapper">
     ...
     <div id='content-wrapper' style='margin-left: 15px'>
      <?php
      $data = $config->pega_etiqueta_individual($empresa_id);
      $conteudo = $data[0]['codigo'];
      $id = $data[0]['id'];
      ?>
        <h3><i class="fas fa-fw fa fa  fa-cube"></i> Etiqueta Individual:</h3><br>
        <i><b>Campos disponíveis: </b>nome, nascimento, rg, cpf, nome_empresas, data_cadastro, valor e descricao</i><Br><br><br>
        <form action="../controller/altera_etiqueta_individual.php" method="post">
        <input type="hidden" name="id" value="<?= $id ?>">
        <textarea name="codigo" cols="85" rows="10" style="border-radius: 24px; border: 6px solid #888;"><?= $conteudo?></textarea><Br>
