    ...
    <div id="wrapper">
     ...
     include("../model/config.php");
      ...
      <div id="content-wrapper" style="margin-left: 15px">
       ...
       $id_saida = $_GET['id'];
       //salto =  + 15920 - 350
       $id_saida = $id_saida - 15920 + 350;
       $data = array();
       $data = $config->pega_financas($id_saida);

       foreach ($data as $row) {
       ?>
       <form action="../controller/editar_financas.php" method="POST">
