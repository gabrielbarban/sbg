     ...
     include("../model/config.php");
      ...
      <div id="content-wrapper" style="margin-left: 15px">
        <div class="container-fluid">
          ...
          <h3><i class='fas fa fas fa-dollar-sign'></i> Novo valor:</h3>
          <form action="../controller/nova_empresa_valor.php" method="POST">
            <input type="hidden" class="form-control" name="empresas_id" value=<?= $_GET["id_empresas"] ?>>
            <input type="text" class="form-control" name="nome" placeholder="Nome" required="required">
            <br>
            <input type="text" class="form-control" name="valor" placeholder="Valor" onkeyup="alteraPonto($(this))" required="required">
            <br>
            <input type="text" class="form-control" name="prazo" placeholder="Prazo" value='0'>
            <br>
