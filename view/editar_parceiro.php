    ...
    <div id="wrapper">
     ...
     include("../model/config.php");
      ...
      <div id="content-wrapper" style="margin-left: 15px">
        <h3><i class="fas fa fa fa-handshake"></i> Atualização de parceiro: </h3>
       <?php 
       //SALTO: +150-11+18-78
       ...
       $data = array();
       $data = $config->pega_parceiro($id_parceiro);

       foreach ($data as $row) {
       ?>
       <form action="../controller/editar_parceiro.php" method="POST">
