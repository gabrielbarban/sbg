     ...
     include("../model/config.php");
      ...
      <div id="content-wrapper" style="margin-left: 15px">
       ...
       <form action="../controller/edita_dados_usuario.php" method="POST">
          ...
          Username:
          <input type="text" class="form-control" value='<?= $row['usuario']?>' name="usuario" placeholder="Username" required="required">
          <br>

          Senha:
          <input type="password" class="form-control" value='<?= $row['senha']?>' name="senha" placeholder="Senha" required="required">
          <br>

          Senha novamente:
          <input type="password" class="form-control" value='<?= $row['senha']?>' name="senha2" placeholder="Senha novamente" required="required">
          <br>

          E-mail:
          <input type="text" class="form-control" value='<?= $row['email']?>' name="email" placeholder="E-mail" required="required">
          <br>
