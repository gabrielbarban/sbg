...
$id_usuario_login = $_SESSION["usuario_id"];
      ...
      <div id="content-wrapper">
        ...
        <div style="margin-left: 400px; margin-top: 100px;">
           ...
           <?php 
            ...
            if($id_usuario == $id_usuario_login)
             echo ("<SCRIPT LANGUAGE='JavaScript'>
              window.alert('Você não pode excluir um usuário que esta logado.')
              window.location.href='usuarios.php';
              </SCRIPT>");
           ?>
           <h5>Tem certeza que deseja excluir?</h5>

           <a class="nav-link" href="../controller/apaga_usuario.php?id=<?= $id_usuario ?>">
