  ...
  <body id="page-top">
    ...
    <div id="wrapper">
     ...
     <div id='content-wrapper' style='margin-left: 15px'>
      <h3><i class="fas fa-fw fa fa-graduation-cap"></i> Central de ajuda</h3>
      <br><br>

      <b>Como cadastrar um novo convênio?</b> <a target="_blank" href="../arquivos/cadastro_convenio.pdf">Clique aqui</a><br>

      <b>Como cadastrar um novo procedimento?</b> <a target="_blank" href="../arquivos/procedimento.pdf">Clique aqui</a><br>

      <b>Como cadastrar uma nova forma de pagamento?</b> <a target="_blank" href="../arquivos/forma_pagamento.pdf">Clique aqui</a><br>

      <b>Como cadastrar uma nova categoria financeira?</b> <a target="_blank" href="../arquivos/categoria.pdf">Clique aqui</a><br>

      <b>Como cadastrar um novo parceiro?</b> <a target="_blank" href="../arquivos/parceiro.pdf">Clique aqui</a><br>

      <b>Como cadastrar um novo status?</b> <a target="_blank" href="../arquivos/status.pdf">Clique aqui</a><br>
