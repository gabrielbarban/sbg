    ...
    <div id="wrapper">
     ...
     include("../model/config.php");
      ...
      <div id="content-wrapper" style="margin-left: 15px">
        <h3><i class="fas fa fa fa-credit-card"></i> Atualização de forma de pagamento: </h3>
       <?php 
       //SALTO: +150-11+18-78

       $id_forma = $_GET['id'];
       //salto =  + 15920 - 350
       $id_forma = $id_forma - 15920 + 350;
       $data = array();
       $data = $config->pega_forma_de_pagamento($id_forma);

       foreach ($data as $row) {
       ?>
       <form action="../controller/editar_forma_pagamento.php" method="POST">
