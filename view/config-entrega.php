        ...
        <div class="container-fluid">
          ...
          <?php
            ...
            foreach ($data as $row) {
              ...
              $id = $row['id'] + 15920 - 350;
              echo "<td>
                <a href='editar_entrega.php?id=".$id."?id_entrega=".$var_hash."'><i class='fas fa fa-edit' title='Editar'></i></a>
                <a href='apagar_entrega.php?id=".$id."?id_entrega=".$var_hash."'><i class='fas fa fa-times' title='Excluir'></i></a>
              </td></tr></tbody>";   
          ...
          ?>
            ...
            <span>Voltar</span></a>
            <a class="btn btn-primary" href="nova_entrega.php" >Cadastrar nova forma de entrega <i class='fas fa fa fa-plus'></i></a>
