    ...
    <div id="wrapper">
     ...
     include("../model/config.php");
      ...
      <div id="content-wrapper" style="margin-left: 15px">
        <h3><i class="fas fa fa fa-id-card"></i> Atualização de usuário: </h3>
       <?php 
       //SALTO: +150-11+18-78
       ...
       $data = array();
       $data = $config->pega_usuario($id_usuario);
       ...
       <form action="../controller/editar_usuario.php" method="POST">
          ...
          Nome:
          <input type="text" class="form-control" value='<?= $row['nome']?>' name="nome" placeholder="Nome" required="required"><br>
          Usuário:
          <input type="text" class="form-control" value='<?= $row['usuario']?>' name="username" placeholder="Username" required="required"><Br>
          E-mail:
          <input type="text" class="form-control" value='<?= $row['email']?>' name="email" placeholder="E-mail"><Br>
          Senha:
          <input type="password" class="form-control" value=<?= $row['senha']?> name="senha" placeholder="Senha" required="required"><br>
          Senha novamente:
          <input type="password" class="form-control" value=<?= $row['senha']?> name="senha2" placeholder="Senha novamente" required="required"><br>
          <input type="submit" class="form-control" value="Salvar" style="background-color: #ced4da;">
        </form>
        <br>
        <a class="btn btn-primary" href="usuarios.php" ><i class="fas fa-fw fa fa  fa fa-reply"></i>
            <span>Voltar</span></a>
      </div>
    <?php } ?>
      <!-- /.content-wrapper -->
