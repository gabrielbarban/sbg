...
<html lang="pt-br">
  ...
  <body id="page-top">
    ...
    <div id="wrapper">
     ...
     <div id='content-wrapper' style='margin-left: 15px'>
      <h3><i class="fas fa-fw fa fa fa-database"></i> Importação de dados</h3><br>
      
  <h5>Parceiros (arquivo exemplo: <a href="../arquivos/planilha_parceiros.xml" download="parceiros.xml">download</a>)</h5>
  <form enctype="multipart/form-data"action="../controller/importa_parceiros.php" method="post">
  ...
  <br><br>
  <h5>Usuários</h5>
  <form enctype="multipart/form-data"action="../controller/importa_excel.php" method="post">
    <input type="hidden" name="MAX_FILE_SIZE" value="2000000" />
    <table width="600">
      <tr>
      <td>Selecione o arquivo:</td>
