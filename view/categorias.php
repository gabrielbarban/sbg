    ...
    <div id="wrapper">
     ...
     include("../model/firewall.php");
      ...
      <div id="content-wrapper" style="margin-left: 15px">
        <h3><i class="fas fa fa fa-tags"></i> Categorias financeiras</h3><br>
        <div class="container-fluid">
          ...
          <?php
            ...
            foreach ($data as $row) {
              ...
              $id = $row['id'] + 15920 - 350;
              echo "<td>
                <a href='editar_categoria.php?id=".$id."?id_status=".$var_hash."'><i class='fas fa fa-edit' title='Editar'></i></a>
                <a href='apagar_categoria.php?id=".$id."?id_status=".$var_hash."'><i class='fas fa fa-times' title='Excluir'></i></a>
              </td></tr></tbody>";   
          ...
          ?>
            ...
            <span>Voltar</span></a>
            <a class="btn btn-primary" href="nova_categoria.php" >Cadastrar nova categoria <i class='fas fa fa fa-plus'></i></a>
