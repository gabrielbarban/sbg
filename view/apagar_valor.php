     ...
     include("../model/config.php");
      ...
      <div id="content-wrapper">
        ...
        <div style="margin-left: 400px; margin-top: 100px;">
           ...
           <a class="nav-link" 
  href="../controller/apaga_valor.php?id=<?= $id_valor ?>&id_empresas=<?= $id_empresas ?>&empresa='<?= $nome_empresa ?>'">
            <i class="fas fa-fw fa fa-check"></i>
           <span>Sim</span></a>
           ...
           ?>
           <a class="nav-link" href="../view/listar_valores.php?id=<?= $id_empresas?>&empresa=<?=$nome_empresa?>">
