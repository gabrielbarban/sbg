  ...
  <body id="page-top">
    ...
    <div id="wrapper">
     ...
     <div id='content-wrapper' style='margin-left: 15px'>
      <h3><i class="fas fa-fw fa fa-envelope-open"></i> Campanhas - Parceiros</h3><br>
     ...
     <div class="table-responsive">
          ...
          <?php
            ...
            $data = array();
            $data=$config->lista_campanhas($empresa_id, 1);
            ...
            foreach ($data as $row) {
              ...
              $id = $row['id'] + 15920 - 350;
              echo "<td>
                <a href='enviar_campanha_parceiros.php?id=".$id."?id_campanha=".$var_hash."'><i class='fas fa fa-rocket' title='Enviar para a base'></i></a>
