  ...
  <body id="page-top">
    ...
    <div id="wrapper">
     ...
     <div id='content-wrapper' style='margin-left: 15px'>
        <h3><i class="fa fa-download"></i> Exportação de dados</h3>
      <br><br>
      <a class="nav-link" href="../controller/exporta_parceiros.php">
            <i class="fas fa fa fa-handshake"></i>
            <span>Parceiros</span></a>

            <a class="nav-link" href="../controller/exporta_usuarios.php">
