    ...
    <div id="wrapper">
     ...
     include("../model/config.php");
      ...
      <div id="content-wrapper" style="margin-left: 15px">
        <h3><i class="fas fa-fw   fa fa-clone"></i> Atualização de status: </h3>
       <?php 
       //SALTO: +150-11+18-78

       $id_status = $_GET['id'];
       //salto =  + 15920 - 350
       $id_status = $id_status - 15920 + 350;
       $data = array();
       $data = $config->pega_status($id_status);

       foreach ($data as $row) {
       ?>
       <form action="../controller/editar_status.php" method="POST">
