   ...
   <?php
     include("../model/config.php");
      ...
      <div id="content-wrapper" style="margin-left: 15px">
        ...
        <h3><i class="fas fa-fw fa fa-image"></i> Logo</h3>
        <br>
        <form method="post" enctype="multipart/form-data" action="../controller/salva_logo.php">
           Selecione uma imagem: <input name="arquivo" type="file" accept="image/png" />
           <input type="submit" value="Salvar" />
        </form>
        <br><br>
        <img src="../uploads/logo-<?= $empresa_id ?>.png">
        <br><br><br><br>
        <a class="btn btn-primary" href="companhia.php" ><i class="fas fa-fw fa fa  fa fa-reply"></i><span>Voltar</span></a>
