    ...
    <div id="wrapper">
     ...
     include("../model/config.php");
      ...
      <div id="content-wrapper" style="margin-left: 15px">
        <?php
          $id = $_SESSION["id_cliente_historico"];
          $data = $config->busca_cliente_id($id);
        ...
        <h3><i class="fas fa-fw   fa  fa fa-child"></i> Cliente: <?= $nome ?></h3><br>
        <form action="../controller/atualiza_cliente.php" method="post">
          <input type="hidden" name="id" value="<?= $id ?>">
          Nome: <input class="form-control" type="text" name="nome" value="<?= $nome ?>"><br>
          Data de nascimento: <input class="form-control" type="text" name="data_nasc" value="<?= $data_nasc ?>"><br>
          CPF: <input class="form-control" type="text" name="cpf" value="<?= $cpf ?>"><br>
          RG: <input class="form-control" type="text" name="rg" value="<?= $rg ?>"><br>
          Telefone: <input class="form-control" type="text" name="telefone" value="<?= $telefone ?>"><br>
          Celular: <input class="form-control" type="text" name="celular" value="<?= $celular ?>"><br>
          E-mail: <input class="form-control" type="text" name="email" value="<?= $email ?>"><br>
          Endereço: <input class="form-control" type="text" name="endereco" value="<?= $endereco ?>"><br>
          <br>
          <input class="form-control" style="background-color: #ced4da;" type="submit" value="Salvar">
        </form>
